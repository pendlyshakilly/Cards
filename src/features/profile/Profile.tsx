...
debugger
		...
		const onClickHandler = () => {
				...
				editMode && dispatch(authThunks.updateDataProfile(name));
		};
			...
			<div className={s.Container}>
					...
					<Paper className={s.Paper}>
							...
							{editMode ?
								<FormControl sx={{ m: 1, width: "347px", position: "relative" }} variant="standard">
										...
										<Button disabled={!name}
														style={{ position: "absolute", top: "12px", right: "12px", fontWeight: "400" }}
														variant={"contained"} onClick={onClickHandler}>Save</Button>
										{!name && <div style={{ color: "red" }}> write your name</div>}
								</FormControl>
								: <h3><span
									style={{ fontWeight: "500", marginRight: "10px", fontSize: "20px" }}>{name}</span><BorderColorIcon
							...
							<Button
								...
								variant={"contained"}
								sx={{ backgroundColor: "#FCFCFC", color: "black", borderRadius: "40px" }}>
